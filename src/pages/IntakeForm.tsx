  ...
  return (
    <div className="min-h-screen bg-void">
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-8">
        ...
        {/* PDF DOWNLOADS BANNER */}
        {step === 1 && (
          <div className="mb-8 bg-gradient-to-r from-brand-blue/10 to-crimson/10 border border-brand-blue/30 rounded-lg p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex-1">
                <h3 className="font-body text-sm uppercase tracking-[1.5px] text-brand-blue mb-2">Reference Documents</h3>
                <p className="font-body text-xs text-mist">Download our intake forms to review offline or print for your records</p>
              </div>
              <div className="flex flex-wrap gap-3">
                <a href="/forms/Personal-Lines-Placement-Intake-06-15-26.pdf" download className="bg-brand-blue hover:bg-brand-blue/80 text-white font-body text-[11px] uppercase tracking-[1.5px] px-4 py-2 rounded transition-colors">
                  📄 Personal Lines
                </a>
                <a href="/forms/Placement-Intake-Form-Internal.pdf" download className="bg-crimson hover:bg-arabian-red text-white font-body text-[11px] uppercase tracking-[1.5px] px-4 py-2 rounded transition-colors">
                  📋 Internal Form
                </a>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between mt-10 pt-6 border-t border-dark-mist">
          ...
          {step < 10 ? (
            ...
            <button onClick={handleSubmit} disabled={createIntake.isPending}
              ...
              {createIntake.isPending ? <><Loader2 size={14} className="animate-spin" /> Submitting...</> : <>Submit Intake <Check size={14} /></>}
            </button>
          )}
        </div>
      </main>
